...
Crake runs locally as a Streamlit app. It fetches public sequences from NCBI Entrez and UniProt when you use fetch/genesearch commands. Do not commit `.env`, API keys, or personal `.mcp.json` files.
